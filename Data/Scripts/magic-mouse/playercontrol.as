...
/*
 *	Original Overgrowth 1.4 playercontrol.as with two modifications.
 *
 *	1: Attack disabled: bool WantsToAttack()
 *	2: Z-Axis Movement disabled: vec3 GetTargetVelocity()
 *
 */
...
bool WantsToAttack() {
	// Don't we have enough pain on this planet already?
	return false;
}
